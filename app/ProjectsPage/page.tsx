						...
						<a href="https://github.com/Blair4932/GitBash">
							<ProjectCard>
								...
								<ProjectCardParagraph>
									...
									style. It was created with a React
									front-end, used express for routing, and
									MongoDB to manage our database. We also used
									sockets.io to manage websockets, for
									multiplayer intergration. This was great fun
									to make, and we did a lot in the course of
									the single week that we had. I&apos;m very
									proud of this one.
								</ProjectCardParagraph>
							</ProjectCard>
						</a>
					...
					<li>
						<a href="https://github.com/JoshNBooker/spook_city_app">
							<ProjectCard>
								...
								<ProjectCardParagraph>
									Spook City is a mobile app designed to give
									a fun, interactive and educational ghost
									finding experience around Edinburgh. It uses
									a Java / Springboot back-end with front end
									made with React Native, Typescript and Expo.
									This was great fun to make, and it was quite
									a challenge to learn to use Expo&apos;s
					...
					<li>
						<a href="https://github.com/JoshNBooker/Sakura_Spa_booking_app">
							<ProjectCard>
								...
								<ProjectCardParagraph>
									This was the first project I did at
									CodeClan, so it&apos;s pretty basic.
									I&apos;m still pround of it however, and I
									think it has some pretty cool styling.
									It&apos;s all done in Python and Jinja, with
									Flask managing the backend.
								</ProjectCardParagraph>
							</ProjectCard>
						</a>
					</li>
